...
<template>
  ...
  <main>
    ...
    <div class="carrossel ">
      <swiper-container navigation="true" space-between="670" slides-per-view="3" loop="true" autoplay-delay="2500" autoplay-disable-on-interaction="false">
    ...
    <section class="sobre">
      <div class="imgsobre">
        <img src="/src/assets/imagens/imgsobre.png" alt="carro1">
      </div>
