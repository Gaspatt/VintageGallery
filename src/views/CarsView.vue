...
const cars = [
  ...
  },
  {
    ...
    description: 'O Dodge Charger é um modelo de automóvel comercializado pela Dodge em várias formas ao longo de sete gerações desde 1966. O primeiro Charger foi um show car em 1964. Um carro-conceito Charger II de 1965 lembrava a versão de produção de 1966. O Charger foi construído em três plataformas diferentes em vários tamanhos. Nos Estados Unidos, a placa de identificação Charger foi usada em hatchbacks subcompactos, sedãs de tamanho normal, muscle cars e cupês de luxo pessoais. A versão atual é um sedã de quatro portas.',
    specifications: 'Este carro tem um V8 Dodge 318 e câmbio manual de 4 marchas com tudo funcionando normalmente. Recebeu revisão recentemente. Todos os sistemas funcionando.',
    interior: 'Seu interior está em bom estado, sem rasgos ou imperfeições, suas capas de porta, carpete e forro de teto estão em muito bom estado de conservação.',
    photos: [
  ...
  },
  {
    ...
    description: 'Veraneio é um utilitário esportivo (SUV) produzido pela Chevrolet do Brasil de 1964 a 1994 substituindo a Chevrolet Amazona, desenhada por Luther Whitmore Stier, inspirado na Chevrolet Suburban norte-americana.',
    specifications: 'Essa unidade possui um motor 6 cilindros e câmbio manual na coluna, ambos funcionando normalmente.Painel original, sem manchas ou riscos, com todos acabamentos e botões. Tudo funcionando normalmente.',
    interior: 'Seu interior original está em bom estado de conservação, sem rasgos ou imperfeições, suas capas de porta estão em muito bom estado.',
    photos: [
  ...
  },
  {
    ...
    description: 'O Volkswagen Kombi foi um veículo comercial ligeiro produzido pela empresa automotiva alemã Volkswagen, entre 1950 e 2013. Sua construção robusta monobloco (sem chassi), suspensão independente com barras de torção, além da excêntrica posição do motorista no automóvel (sentado sobre o eixo dianteiro e com a coluna de direção praticamente vertical), o tornam um veículo simples e robusto, de baixo custo de manutenção.',
    specifications: 'Esse exemplar possui um motor VW 1600 e câmbio manual, ambos devidamente revisados e funcionando normalmente.Seu painel está em muito bom estado de conservação sem qualquer tipo de imperfeição ou trincos, seus mostradores foram revisados e funcionam normalmente.',
    interior: 'Seu interior está em muito bom estado, sem rasgos ou imperfeições, suas capas de porta, carpete e forro de teto estão em muito bom estado de conservação.',
    photos: [
  ...
  },
  {
    ...
    description: 'A linha Volkswagen 1600 foi, juntamente com o Fusca e a Kombi, a base da presença da Volkswagen no mercado brasileiro até a chegada do Passat, em 1974. Todos eram equipados com motores traseiros refrigerados a ar e mesma plataforma mecânica do Fusca. Possuía uma fácil adaptação para sistemas de sobrealimentação, seja com turbocompressores ou superchargers (compressores).',
    specifications: 'Essa unidade possui um motor VW e câmbio manual, ambos devidamente revisados e funcionando normalmente.Seu painel está em bom estado de conservação, seus mostradores foram revisados e funcionam normalmente.',
    interior: 'Seu interior está em bom estado, sem rasgos ou imperfeições, suas capas de porta, carpete e forro de teto estão em muito bom estado de conservação.',
    photos: [
